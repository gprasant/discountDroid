...
implements ScanActivity.Listener, SlidingDrawer.OnDrawerCloseListener, 
    ...
    private void displayDiscount(String productName) {
        ...
        Discount discount = discountService.fetchDiscount(productName);
    ...
    private void setOfferHolderVisibility(boolean visibility){
        int v = visibility ? VISIBLE : INVISIBLE;
        View offerHolder = findViewById(R.id.offerHolder);
        offerHolder.setVisibility(v);
    }
